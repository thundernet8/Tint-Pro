...
/* ------------------------------------ */  
    'sections'        => array(
		...
		array(
            'id'        => 'membership',
            'title'     => __('会员系统','tinection')
        ),
		array(
            'id'        => 'shop',
            'title'     => __('商品系统','tinection')
        ),
        array(
            'id'        => 'admin',
...
/* ------------------------------------ */
    'settings'        => array(
		...
		// Credit: 现金积分兑换比率
        array(
            'id'        => 'tin_cash_credit_ratio',
            'label'     => __('现金积分兑换比率','tinection'),
            'desc'      => __('1元所能兑换的积分数，用于计算积分充值','tinection'),
            'type'      => 'text',
            'std'       => '50',
            'section'   => 'credit'
        ),
		...
		array(
            'id'        => 'member_system',
            'label'     => __('开启会员系统','tinection'),
            'desc'      => __('开启会员系统,会创建相关数据库','tinection'),
            'type'      => 'on-off',
            'std'       => 'off',
            'section'   => 'membership'
        ),
		...
		array(
            ...
            'label'     => __('月费会员价格','tinection'),
            'desc'      => __('月费会员价格,单位:元','tinection'),
            'type'      => 'text',
            'std'       => '10',
            'section'   => 'membership'
        ),
		...
		array(
            ...
            'label'     => __('季费会员价格','tinection'),
            'desc'      => __('季费会员价格,单位:元','tinection'),
            'type'      => 'text',
            'std'       => '25',
            'section'   => 'membership'
        ),
		...
		array(
            'id'        => 'vip_annual_price',
            'label'     => __('年费会员价格','tinection'),
            'desc'      => __('年费会员价格,单位:元','tinection'),
            'type'      => 'text',
            'std'       => '90',
            'section'   => 'membership'
        ),
		...
		array(
            'id'        => 'shop_system',
            'label'     => __('开启商品系统','tinection'),
            'desc'      => __('开启商品系统,必须同时开启会员系统以计算优惠等内容','tinection'),
            'type'      => 'on-off',
            'std'       => 'off',
            'section'   => 'shop'
        ),
		...
		array(
            'id'        => 'alipay_partner',
            'label'     => __('支付宝商家身份ID','tinection'),
            'desc'      => __('合作身份者id，以2088开头的16位纯数字','tinection'),
            'type'      => 'text',
            'std'       => '',
            'section'   => 'shop'
        ),
		...
		array(
            'id'        => 'alipay_key',
            'label'     => __('支付宝商家身份Key','tinection'),
            'desc'      => __('支付宝商家身份安全检验码，以数字和字母组成的32位字符','tinection'),
            'type'      => 'text',
            'std'       => '',
            'section'   => 'shop'
        ),
		...
		array(
            'id'        => 'alipay_service',
            'label'     => __('支付宝商家收款类型','tinection'),
            'desc'      => __('支付宝商家收款类型，只支持双功能和担保交易,注意：切换类型后必须对应修改商家身份key','tinection'),
            'type'      => 'select',
			'choices'   => array( 
                             array(
                                'value'       => 'create_direct_pay_by_user',
                                'label'       => __('即时到账','tinection'),
                                ),
                             array(
                                'value'       => 'trade_create_by_buyer',
                                'label'       => __('双功能收款','tinection'),
                                ),
                             array(
                                'value'       => 'create_partner_trade_by_buyer',
                                'label'       => __('担保交易','tinection'),
                                ),
                           ),
        ...
        array(
            ...
            'label'     => __('商品归档页链接后缀','tinection'),
            'desc'      => __('商品归档页链接后缀,默认为store，即默认可以通过<a href="'.$blogurl.'/store" target="_blank">'.$blogurl.'/store</a>访问商品归档页','tinection'),
            'type'      => 'text',
            'std'       => 'store',
            'section'   => 'shop'
        ),
        ...
        array(
            ...
            'label'     => __('商品展示页固定链接模式','tinection'),
            'desc'      => __('商品展示页固定链接模式,请根据普通文章的固定链接模式选择','tinection'),
            'type'      => 'select',
            'choices'   => array( 
                             array(
                                'value'       => 'post_id',
                                'label'       => __('POST ID','tinection'),
                                ),
                             array(
                                'value'       => 'post_name',
                                'label'       => __('POST NAME','tinection'),
                                ),
                           ),
            'std'       => 'post_id',
            'section'   => 'shop'
		...
		array(
            ...
            'label'     => __('商品归档页副标题','tinection'),
            'desc'      => __('商品归档页副标题','tinection'),
            'type'      => 'text',
		...
		// Admin: 禁用密码找回
        array(
            'id'        => 'disable_reset_pwd',
            'label'     => __('禁用密码找回','tinection'),
            'desc'      => __('禁用密码找回,防止通过此接口无限找回密码请求并发送邮件卡死主机','tinection'),
            'type'      => 'on-off',
            'std'       => 'off',
            'section'   => 'admin'
        ),
