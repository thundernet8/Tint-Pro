/**
 * Generated on Sat Dec 24 2016 20:08:32 GMT+0800 (中国标准时间) by Zhiyan
 *
 * @package   Tint
 * @version   v2.0.0
...
(function (modules) {
    ...
    function (module, exports, __webpack_require__) {
        (function (jQuery) {
            ...
            var _dailySign = __webpack_require__(28);
            var _dailySign2 = _interopRequireDefault(_dailySign);
            var _creditsCharge = __webpack_require__(29);
            var _creditsCharge2 = _interopRequireDefault(_creditsCharge);
            var _contribute = __webpack_require__(30);
            ...
            jQuery(document)[['ready']](function ($) {
                ...
                _dailySign2[['default']][['init']]();
                _creditsCharge2[['default']][['init']]();
                _contribute2[['default']][['init']]();
            });
    ...
    function (module, exports, __webpack_require__) {
        (function ($) {
            ...
            var _submitting = false;
            var _handleDailySign = function _handleDailySign(btn) {
                if (_submitting || !_utils2[['default']][['checkLogin']]())
                    return false;
                var data = {};
                var url = _globalConfig[['Routes']][['otherActions']] + '/daily_sign';
                var beforeSend = function beforeSend() {
                    if (_submitting)
                        return;
                    btn[['prop']]('disabled', true);
    ...
    function (module, exports, __webpack_require__) {
        (function ($) {
            ...
            var _spinner = '<i class="tico tico-spinner9 spinning"></i>';
            var _submitting = false;
            var _handleCreditsCharge = function _handleCreditsCharge(btn) {
                if (_submitting || !_utils2[['default']][['checkLogin']]())
                    return false;
                var chargeNumInput = $(_chargeNumInputSel);
                var chargeNum = chargeNumInput[['length']] ? parseInt(chargeNumInput[['val']]()) : 10;
                var data = { amount: chargeNum };
                var url = _globalConfig[['Routes']][['otherActions']] + '/credits_charge';
                var beforeSend = function beforeSend() {
                    if (_submitting)
                        return;
                    btn[['prop']]('disabled', true);
            ...
            var CreditsCharge = { init: _init };
            exports[['default']] = CreditsCharge;
        }[['call']](exports, __webpack_require__(1)));
    },
    function (module, exports, __webpack_require__) {
        (function ($) {
            ...
            var _submitting = false;
            var _warning = function _warning(text) {
                _msgbox[['popMsgbox']][['warning']]({
                    title: text,
                    timer: 2000,
                    showConfirmButton: true
                });
            };
            var _handleContribute = function _handleContribute(btn) {
                if (_submitting || !_utils2[['default']][['checkLogin']]())
                    return false;
                var data = {};
                ...
                var url = postId < 1 ? _globalConfig[['Routes']][['posts']] : _globalConfig[['Routes']][['posts']] + '/' + postId;
                var beforeSend = function beforeSend() {
                    if (_submitting)
                        return;
                    btn[['prop']]('disabled', true);
