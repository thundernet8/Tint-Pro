/**
 * Generated on Mon Oct 10 2016 23:44:42 GMT+0800 (中国标准时间) by Zhiyan
 *
 * @package   Tint
 * @version   v2.0.0
...
webpackJsonp([
    ...
    function (module, exports, __webpack_require__) {
        (function (jQuery) {
            ...
            var _seasonalBg = __webpack_require__(10);
        ...
        (function ($) {
            ...
            var _validateUserLogin = function _validateUserLogin() {
                if (_userLoginInput[['val']]() === '') {
                    ...
                    return false;
                } else if (!_utils[['Utils']][['isValidUserName']](_userLoginInput[['val']]()) && !_utils[['Utils']][['isEmail']](_userLoginInput[['val']]())) {
            ...
            var _post = function _post() {
                var url = _utils[['Utils']][['getAPIUrl']]('/session');
                ...
                var success = function success(data, textStatus, xhr) {
                    if (data[['success']] && data[['success']] == 1) {
                        var redirect = _utils[['Utils']][['getUrlPara']]('redirect') ? _utils[['Utils']][['getAbsUrl']](decodeURIComponent(_utils[['Utils']][['getUrlPara']]('redirect'))) : _utils[['Utils']][['getSiteUrl']]();
        ...
        (function ($) {
            ...
            var _validateEmail = function _validateEmail(showMsg) {
                if (_emailInput[['val']]() === '') {
                    ...
                    return false;
                } else if (!_utils[['Utils']][['isEmail']](_emailInput[['val']]())) {
                    if (showMsg) {
            ...
            var _post = function _post() {
                var url = _utils[['Utils']][['getAPIUrl']]('/users');
                var beforeSend = function beforeSend() {
    ...
    function (module, exports, __webpack_require__) {
        (function (TT, $) {
            ...
            var _getSeasonalBg = function _getSeasonalBg() {
                var bgRootUrl = TT && TT[['themeRoot']] ? TT[['themeRoot']] + '/assets/img/spotlight/' : _utils[['Utils']][['getSiteUrl']]() + '/wp-content/themes/Tint/assets/img/spotlight/';
                var _date = new Date();
