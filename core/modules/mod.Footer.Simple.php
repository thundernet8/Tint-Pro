...
<footer class="footer simple-footer">
    ...
    <div class="foot-copyright pull-right">&copy;&nbsp;<?php echo tt_copyright_year(); ?><?php echo ' ' . get_bloginfo('name') . ' All Right Reserved · <b style="color: #ff4425;">♥</b>&nbsp;<a href="https://www.webapproach.net/tint" title="Tint">Tint</a> & Design by <a href="https://www.webapproach.net" rel="link" title="WebApproach">WebApproach.</a>'; ?>
    </div>
</footer>
