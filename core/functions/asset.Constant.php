...
defined('JS_HOME') || define('JS_HOME', 'home-a3ac67eb86.js');
defined('JS_FRONT_PAGE') || define('JS_FRONT_PAGE', 'frontPage-e0fd0122b4.js');
defined('JS_SINGLE') || define('JS_SINGLE', 'single-353c8e09d5.js');
defined('JS_PAGE') || define('JS_PAGE', 'page-0ffe910063.js');
defined('JS_ARCHIVE') || define('JS_ARCHIVE', 'archive-539934a58a.js');
defined('JS_PRODUCT') || define('JS_PRODUCT', 'product-60eab4b7c6.js');
defined('JS_PRODUCT_ARCHIVE') || define('JS_PRODUCT_ARCHIVE', 'products-4492dbd35c.js');
defined('JS_UC') || define('JS_UC', 'uc-d1a4af2c0d.js');
defined('JS_ME') || define('JS_ME', 'me-e6200e66bc.js');
