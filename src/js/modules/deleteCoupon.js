...
var _submitBtnSel = '.delete-coupon';

var _submitting = false;


var _handleDeleteCoupon = function (btn) {
    if(_submitting || !Utils.checkLogin()) return false;
    
    var data = {};
    
    var url = Routes.coupons + '/' + btn.data('coupon-id');
